...
<div class="container">
   <div class="row">
    ...
    <div class="container">
         <div class="row">
         <div class="col-sm-12 shadow-lg p-3 mb-5 bg-body rounded customHeight">
           <div class="row">
               <ul class="nav nav-tabs" id="customTab" role="tablist">
                <li class="inline"><a href="#schedule" data-toggle="tab" class="nav-link active adminTab">Schedule</a></li>
                <li class="inline"><a href="#bookings" data-toggle="tab" class="nav-link adminTab">All requests</a></li>
                <li class="inline"><a href="#request" data-toggle="tab" class="nav-link adminTab">Create a Request</a></li>
              </ul>
         </div>
           <div class="tab-content">
              ...
              <div class="tab-pane py-3" id="request">
                  ...
                  <div class="tab-pane py-3" id="schedule">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <?php foreach ($acceptedBookings->result() as $row) {?>
                        <tr>
                          <td><?php echo $row->service;?></td>
                          <td><?php echo $row->bookingDate;?></td>
                          <td><?php
