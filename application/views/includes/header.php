...
<body>
  <nav class="navbar bg-dark">
    ...
    <ul class="navbar-nav px-3">
      ...
      <li class="nav-item px-3">
      <a class="nav-link p-0" href="<?php echo base_url()?><?php if($this->session->isAdmin){echo "index.php/adminbookings";} else{echo "index.php/bookings";}?>">
      ...
      <li class="nav-item px-3">
        <a class="nav-link p-0" href="<?php echo base_url();?>index.php/profile">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fff" class="bi bi-gear" viewBox="0 0 16 16">
      ...
      <li class="nav-item px-3">
          <a class="nav-link p-0" href="<?php echo base_url();?>index.php/user_controller/logout">
      ...
      <nav class="col-md-2 d-none d-md-block bg-light sidebar">
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url()?><?php if($this->session->isAdmin){echo "index.php/admin";} else{echo "index.php/dashboard";}?>">
          ...
          <ul class="nav flex-column mb-2">
            <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url()?><?php if($this->session->isAdmin){echo "index.php/adminbookings";} else{echo "index.php/bookings";}?>">
            ...
            <li class="nav-item">
              <a class="nav-link"href="<?php echo base_url();?>index.php/user_controller/logout">
